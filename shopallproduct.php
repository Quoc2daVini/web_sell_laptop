            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="banner-title">Tất cả sản phẩm</h2>
                        <div class="bread-crumb"><a href="index.php">Trang chủ</a> / Tất cả sản phẩm </div>
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="shop-sidebar">
                            <aside class="widget widget-categories">
                                ...
                                <ul>
                                        ...
                                        <li><a href="shop.php?catID=4">Âm thanh</a></li>
                                        <li><a href="shop.php?catID=1">Bàn nâng hạ</a></li>
                                        <li><a href="shop.php?catID=1">Ghế công thái học</a></li>
                                        <li><a href="shop.php?catID=9">Máy chơi game</a></li>
                                        <li><a href="shop.php?catID=7">Balo, Túi</a></li>
                                        <a href="#">Khuyến mãi</a>
                                        <label class="switch">
                                            <input type="checkbox">
                            ...
                            <aside class="widget">
                                <h3 class="widget-title">Giá (1000 VNĐ)</h3>
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="row">
                            <?php
                            $pd_all = $pd->show_all_product();
                            if ($pd_all){
                                while ($result=$pd_all->fetch_assoc()){
                            ?>
