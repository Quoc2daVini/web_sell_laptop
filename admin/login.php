                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <form action="login.php" method="post">
                                        ...
                                        <img height="75" width="200" alt="" src="../assets/images/logo.png">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-affix">
                                                ...
                                                <input type="text" class="form-control" required="" name="adminUser" placeholder="Tên tài khoản">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-affix m-b-10">
                                                ...
                                                <input type="password" class="form-control" required="" name="adminPass" placeholder="Mật khẩu">
                                            </div>
                                        </div>
                                        <div class="form-group">
