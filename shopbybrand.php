            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="banner-title"><?php $catname = $brand->get_brand_by_id($id);
                        $rs = $catname->fetch_assoc();
                         echo $rs['brandName'];  ?></h2>
                        <div class="bread-crumb"><a href="index.php">home</a> / shop / <?php echo $rs['brandName'];  ?></div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-2">
                        <div class="shop-sidebar">
                            <aside class="widget widget-categories">
                                <h3 class="widget-title">Thương hiệuhiệu</h3>
                                <ul>
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="row">
                            <?php
                            $pd_cat = $pd->get_product_by_brand($id);
                            if ($pd_cat){
